    ...
    <body>
                ...
                <div style="display: flex; justify-content: end; margin: 10px">
                    <div class="dropdown" style="margin-right: 20px">
                        ...
                        <c:if test="${requestScope.role=='3'}">
                            ...
                            <button onclick="openAddModal()"  class="custom-btn btn-crud"><span>Thêm ngay !</span><span>Thêm user</span></button>
                            <!--<a href="ainsertaccount" class="custom-btn btn-crud"><span>Thêm ngay !</span><span>Thêm user</span></a>-->
                                ...
                                <tbody>
                                    <c:forEach items="${accountList}" var="account" varStatus="i" >
                                        <tr>
                                            ...
                                            <td >
                                                <c:if test="${account.role=='3'}">Người dùng</c:if>
                                                <c:if test="${account.role=='2'}">Nhân viên</c:if>

                                                </td>
                                                <td>${account.address}</td>
                                            <td>${account.phone}</td>
                                            <td>                    
                                                <a href="editaccount?id=${account.accId}"  class="custom-btn btn-crud"><span>Sửa ngay!</span><span>Sửa</span></a>
                                            </td>
                                            <td>                                
                                                <a href="#" onclick="showDelMess(${account.accId})"  class="custom-btn btn-crud"><span>Xóa ngay !</span><span>Xóa</span></a>
                                            </td>
                                        </tr>
                                        <% count = count + 1;%>
                                    </c:forEach>
        ...
        <div class="modal-nofi" id="admin-add-modal">
            ...
            <div class="modal-add modal-dialog-scrollable" >
                <form class="full-width" action="ainsertaccount" method="post">
                    <h5 class="modal-add-title">Thêm tài khoản</h5>
                    <div class="modal-body row" style="padding-bottom: 0;">
                        ...
                        <div class="form-group col-md-7">
                            <label>Họ tên</label>
                            <input value="" name="fullname" type="text" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input value="" name="dob" type="date" class="form-control" >
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="modal-btn">
                        <button onclick="checkAdd()"  type="submit" class="custom-btn btn-crud"><span>Thêm ngay !</span><span>Thêm user</span></button>
        ...
        <script>
                            ...
                            function showDelMess(id) {
                                ...
                                if (result === true) {
                                    window.location.href = 'adeleteaccount?id=' + id;
                                }
                            }
