        ...
        <section id="wrapper">
            ...
            <div style="display: flex;">
                <div class=" " style="width: 38%;margin: 2%;background-color: rgba(225, 225, 225, 0.8);border-radius:5px;height: 18rem;">
                    <form  action="managementroom" method="post" >
                        <h5 class="modal-add-title">Thêm phòng</h5>
                        <div class="modal-body" style="padding-bottom: 0;">
                            <div class="form-group ">
                                <label>Tên phòng</label>
                                <input value="" name="roomName" type="text" class="form-control" required>
                        ...
                        <div class="modal-btn">
                            <button onclick="checkAdd()"  type="submit" class="custom-btn btn-crud"><span>Thêm ngay !</span><span>Thêm phòng</span></button>
