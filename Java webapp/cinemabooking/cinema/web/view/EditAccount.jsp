<%-- 
    ...
    Created on : 31-05-2022, 13:42:41
    Author     : Quan
--%>
...
<html lang="en">
    <head>
        ...
        <title>BoomCinema-Sửa tài khoản</title>
        <!-- icon -->
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <img id="image" class="img-account-profile rounded-circle mb-2" src="${pageContext.request.contextPath}/${account.img}" alt="">
                                <!-- Profile picture help block-->
                                <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                <!-- Profile picture upload button-->
                                <div id="myfileupload">
                                    <input value="${pageContext.request.contextPath}/${account.img}}" type="file" name="avatar" id="uploadfile" onchange="readURL(this);" />
                                </div>
                                <div id="thumbbox">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="fullname" class="form-control" type="text" placeholder="Enter your fullname" value="${requestScope.account.fullname}" required >
                                </div>
                                <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="address" class="form-control" type="text" placeholder="Nhập địa chỉ của bạn" value="${requestScope.account.address}" >
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="gender" name="gender" type="radio" value="1" <c:if test="${requestScope.account.gender==true}">checked
                                               </c:if>/>Nam 
                                        <input id="gender" name="gender" type="radio" value="0" <c:if test="${requestScope.account.gender==false}">checked
                                               </c:if>/>Nữ 
                                    </div>
                                    <!-- Form Group (role id)-->
                                    <c:if test="${sessionScope.account.role=='1'}">
                                        ...
                                        <li class="dropdown" style="text-align: start;margin-top: 10px;">
                                            ...
                                            <select name="role" style="border-radius: 5px; ">
                                                ...
                                                <c:if test="${requestScope.account.role=='2'}">
                                    ...
                                    <c:if test="${sessionScope.account.role!='1'}">
                                        <div class="col-md-6">
                                            <input name="role" class="form-control" type="hidden" value="${requestScope.account.role}" required>
                                        </div>

                                    </c:if>
                                    <div class="col-md-6">
                                        <input name="id" class="form-control" type="hidden" value="${requestScope.account.accId}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="phone" class="form-control" type="number" placeholder="Enter your phone number" value="${requestScope.account.phone}" required >
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1">Ngày sinh</label>
                                        <input name="dob" class="form-control" type="date" placeholder="Enter your birthday" value="${requestScope.account.dob}" required >
                                    </div>
                                </div>
                                <!--                                Edit message    -->
                                ...
                                <a class="btn btn-primary" href="userprofile?id=${sessionScope.account.accId}">Quay lại</a>
                            </div>
                        </div>
                    </div>
                </div>
