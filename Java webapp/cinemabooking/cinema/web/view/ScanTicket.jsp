...
<html>
    <head>
        ...
        <title>BoomCinema-Chi tiết vé</title>
        <meta charset="UTF-8" />
                    ...
                    <div class="row mt-4" style="color: white;">
                        ...
                        <div class="col">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <c:if test="${order.status==1}">
                                    <div class="flex-sm-col col-7">
                                        <a  href="confirmticket?cartId=${order.cartId}"><button  class="btn btn-success"><span>Xác nhận vé </span></button></a>
                                    </div>
                                </c:if>
                                <c:if test="${order.status==0}">
                                    <div class="flex-sm-col col-auto">
                                        <a  href="${pageContext.request.contextPath}/home"><button  class="custom-btn btn-watch"><span>Quay lại !</span><span>Quay lại</span></button></a>
                                    </div>
                                </c:if>
                            </div>
