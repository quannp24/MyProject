                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                                ...
                                <h4 class="modal-title">Cập nhật dịch vụ ăn uống</h4>
                                
                            
                        </div>
                        <form action="aupdatefd" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${fd.fadId}" type="text" class="form-control" readonly id="input-1" placeholder="ID" name="new_id">
                                </div>
                                <div class="form-group">
                                    <label>Loại sản phẩm</label>
                                    <input value="${fd.category}" type="text" class="form-control" id="input-2" placeholder="Loại sản phẩm ..." name="new_Category">
                                </div>
                                <div class="form-group">
                                    <label>Tên sản phẩm</label>
                                    <input value="${fd.fadName}" type="text" class="form-control" id="input-2" placeholder="Tên sản phẩm ..." name="new_Name">
                                </div>

                                <div>
                                    <p class="text-muted">Ảnh<span style="color:red;"> *</span></p>
                                    <img class="rounded" height="20%" width="30%" id="image" src="${pageContext.request.contextPath}/${fd.image}" />
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/${fd.image}" type="file" name="new_Img" id="uploadfile" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
                                ...
                                <div class="form-group">
                                    <label>Giá (VNĐ)</label>
                                    <input value="${fd.price}" type="text" class="form-control" id="input-10" placeholder="Giá sản phẩm ... " name="new_Price">
                                </div>
