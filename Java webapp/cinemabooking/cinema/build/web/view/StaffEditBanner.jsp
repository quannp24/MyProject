...
<html>
    <head>
        ...
        <title>BoomCinema-Sửa banner</title>
    ...
    <body>
        ...
        <section id="wrapper">
            ...
            <div class="p-4">
                ...
                <div class="modal-add modal-dialog-scrollable" style="height: 50rem;position: relative;">
                    <form class="full-width" action="editbanner" method="post" enctype="multipart/form-data">
                        <h5 class="modal-add-title">Sửa banner</h5>
                        <div class="modal-body row" style="padding-bottom: 0;">
                            <div class="form-group">

                                <input hidden="" type="text" class="form-control" readonly placeholder="ID" value="${banner.id}" name="new_id">
                            </div>
                            <div class="form-group ">
                                <label>Tiêu đề</label>
                            ...
                            <div class="form-group">
                                ...
                                <img class="rounded"  width="30%" id="image" src="${pageContext.request.contextPath}/${banner.img}" />
                                <div id="myfileupload">
                                    <input value="${pageContext.request.contextPath}/${banner.img}" type="file" name="new_Img" id="uploadfile" onchange="readURL(this);" />
                                </div>
                                <div id="thumbbox">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="start" value="${banner.start}" required>
                                </div>

                                <div class="col-md-6">
                                    <input type="date" name="finish" value="${banner.finish}" required>
                                </div>
                            </div>
                        ...
                        <div class="modal-btn">
                            <a><button onclick="checkAdd()"  type="submit" class="custom-btn btn-crud"><span>Sửa ngay !</span><span>Sửa</span></button></a>
